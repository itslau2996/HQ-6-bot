...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName('verwijder')
                .setDescription('Cancel je reservering')
        ),
        ...
        async function embed(choice, dp) {
            return new Promise(async (resolve, reject) => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription('Je hebt je reservering aangepast voor het opkomende **Open voor Jongeren** event')
                    .addFields(
            ...
            async function reserveer(id, choice, week, project, dp, db) {
                db.run('INSERT INTO reservaties(USRID, GEAR, WEEK, project, daypart) values(?, ?, ?, ?, ?)', [id, choice, week, project, dp], async function (err) {
                    if (err) {
                        ...
                        interaction.reply({ content: 'Er was een error, </reservaties:1106196609609502773> voor de huidige beschikbare apperaten.', ephemeral: true })
                    } else {
